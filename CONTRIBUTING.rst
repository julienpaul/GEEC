...
Report bugs at https://github.com/julienpaul/geec/issues
...
https://github.com/julienpaul/geec/issues.
...
Ready to contribute? Here's how to set up `geec` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `geec` repo on GitHub.
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/geec.git
