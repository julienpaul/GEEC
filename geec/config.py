...
def show(cfg):
    ...
    for mass in cfg["masses"]:
        ...
        logger.info("  topo:")
        logger.info(f"    is_topo   : {mass['topo']['is_topo']}")
        logger.info(f"    extension : {mass['topo']['extension']}")
        logger.info(f"    water_density : {mass['topo']['water_density']} kg m-3")
        logger.info("  crs:")
        ...
        logger.info("    Geoid Datum:")
        logger.info(f"      gdatum: {mass['crs']['gdatum']}")
        logger.info("  ---")
